  ...
  return (
    <section className="analytics-panel">
      <div className="page-header" style={{ marginBottom: "1rem" }}>
        ...
        <p>
          CSV only for now. Uploading now stages the file, runs the automatic
          review workflow, and either auto-publishes or waits for your sign-off.
        </p>
      </div>
      ...
      <form className="analytics-form" onSubmit={handleSubmit}>
        <div className="analytics-form__row">
          <div>
            ...
            <select
              ...
              disabled={
                isUploading || providers.length === 0 || Boolean(loadError)
              }
            >
        ...
        <p className="analytics-table__muted" style={{ margin: 0 }}>
          Supported in V1: CSV uploads for Goodreads and Amazon/Kindle charts.
          XLSX uploads show a convert-to-CSV message.
        </p>
        ...
        <div className="analytics-actions">
          ...
          >
            {isUploading ? "Uploading…" : "Upload and auto-review"}
          </Button>
        </div>
      </form>
